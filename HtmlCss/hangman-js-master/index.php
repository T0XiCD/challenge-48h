    ...
    <body>
        <div id="hangm">
                ...
                <form>
                 ...
                 <form method="POST" action="page.php"  class="alignement">
                        <p class="txt">Identifiez-vous :</p>
                        <input disabled type="text" name="pseudo" autocomplete="off" class="case"> <br><br>
                        <input disabled type=submit  value="valider" class="valider">
                        </form>
                    
                        <form method="POST" action="monument.html"  class="alignement">
                        <input hidden type=submit  value="indice" class="valider">
                        </form>
        </div>
